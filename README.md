...
当前已完成 V1–V9 基线：认证与资源权限、模型和数据源管理、MySQL/Elasticsearch 智能问答、多轮上下文与查询纠错、知识库与多来源问答、质量评测、审计与可观测性、登录保护，以及非 Docker 生产部署交付。

生产构建、Linux systemd、Windows WinSW、Nginx、备份恢复和回滚说明见 [第七迭代部署文档](docs/第七迭代-部署交付与运行保障.md)。
